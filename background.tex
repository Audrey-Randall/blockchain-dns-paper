...
per-name takedown-resistence, is directly tied to the existence of a
central authority with the ability to take down an individual record.
System-wide takedown-resistence, on the other hand, is commonly a
...
simply block Tor alltogether (i.e., under the assumption that any
...
capability, motivation, and (at times) legal obligation to remove abusive posts used to coordinate C2 activity.  Thus, malware authors are
incentivized to find naming systems that are neither vulnerable to
