...
so this contract is not always able to translate a given node back to a name. 
...
We also performed a web crawl of the Unstoppable names that had records 
pointing to websites, either DS records or records that redirected to 
traditional IPs or domains. We took screenshots of the 367 websites we arrived 
at, inspected them manually, and did not find any evidence of malware use. Most 
...
wallet, instead of in their own wallet~\cite{pegoraro_blockchain_2021}. In 
