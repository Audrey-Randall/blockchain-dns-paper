...
and TinyNuke~\cite{abusech_2017, mackie_cryptodns_2018}. Cerber ransomware has 
...
Malware authors must not only ensure their clients can access the blockchain naming system, but 
also ensure they can modify the addresses stored in the records when they become unavailable.
